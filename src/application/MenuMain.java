...
//			primaryStage.show();
	...
	public void showAllBooking() throws IOException
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(MenuMain.class.getResource("/application/CustomerAllview.fxml"));
		SplitPane loginmenu = loader.load();
		Scene scene = new Scene(loginmenu);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Login");
	}
	...
	{
		FXMLLoader loader = new FXMLLoader();
		loader.setLocation(MenuMain.class.getResource("/application/CustomerOldview.fxml"));
		SplitPane loginmenu = loader.load();
		Scene scene = new Scene(loginmenu);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Login");
	...
	public void showAddEmp() throws IOException{
		...
		SplitPane addEmployee = loader.load();
